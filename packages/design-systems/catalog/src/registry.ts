...
export const catalog = [
  ...
  stable("Text", "Content & Data", "primitive", "@kimgseok/design-primitives", "역할 기반 본문 텍스트."),
  stable("Heading", "Content & Data", "primitive", "@kimgseok/design-primitives", "문서 위계를 보존하는 제목."),
