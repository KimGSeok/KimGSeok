...
export interface ToastContract { /** Use a new id for each notification when message and action label repeat. */ id?: string | number; open: boolean; message: string; tone?: FeedbackTone; durationMs?: number | null; action?: ToastAction; onOpenChange: (open: boolean) => void; }
