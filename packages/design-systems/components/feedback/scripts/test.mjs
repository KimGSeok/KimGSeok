...
if (!web.includes('motion-duration-progress-loop') || web.includes('1.2s ease-in-out') || !native.includes("@kimgseok/design-motion/native")) throw new Error('Feedback must consume semantic motion recipes.');
if (!contracts.includes('decorative?: boolean') || !web.includes('aria-hidden={decorative') || !native.includes('accessible={!decorative}')) throw new Error('Spinner decorative contract is missing.');
