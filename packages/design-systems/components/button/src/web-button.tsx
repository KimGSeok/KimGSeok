...
import { Spinner } from '@kimgseok/design-feedback/web';
...
export function Button({ variant = 'primary', size = 'md', loading = false, disabled = false, leadingIcon, trailingIcon, children, onAction, onActionError, onBlur, onFocus, onKeyDown, onKeyUp, onPointerCancel, onPointerDown, onPointerEnter, onPointerLeave, onPointerUp, ...props }: WebButtonProps) {
